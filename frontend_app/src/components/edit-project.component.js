...
export default class EditProject extends Component {
  ...
  componentDidMount () {
    axios.get('http://localhost:5000/projectlist/' + this.props.match.params.id)
   .then (response => {
     this.setState ({
 ...
 onChangeprojectlistCRMNumber(e) {
 this.setState ({
...
onSubmit (e) {
  ...
  axios.post('http://localhost:5000/projectlist/update/' + this.props.match.params.id, obj)
...
<div className="form-group">
  ...
  onChange={this.onChangeprojectlistdescription}
  />
</div>
...
<div className="form-group">
  ...
  onChange={this.onChangeprojectlistCRMNumber}
  />
</div>
<div className ="form-check">
  ...
  onChange={this.onChangeprojectlistCompleted}
...
<input type ="submit" value = "Update projectlist" className="btn btn-primary" />
</div>
        </form>
